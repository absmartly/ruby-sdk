...
RSpec.describe AndCombinator do
  ...
  describe ".combine" do
    ...
    it "test combine short circuit" do
      expect(combinator.combine(evaluator, [true, false, true])).to be_falsey
    ...
    it "test combine" do
      ...
      expect(combinator.combine(evaluator, [true, false])).to be_falsey
      expect(combinator.combine(evaluator, [false, true])).to be_falsey
